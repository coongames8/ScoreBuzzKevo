...
export const SUBSCRIPTION_PLANS = {
  ...
  dollars: [
    ...
    { id: "60", value: 60, label: "Yearly", price: "$60", period: "Yearly" },
  ],
};

// Get subscription period based on price
export const getSubscriptionPeriod = (price) => {
  if (price === 230 || price === 2) return "Daily";
  if (price === 800 || price === 7) return "Weekly";
  if (price === 2000 || price === 20) return "Monthly";
  if (price === 7500 || price === 60) return "Yearly";
  return "Weekly";
};

// Get plan name based on price
export const getPlanName = (price) => {
  if (price === 230 || price === 1.8) return "Daily";
  if (price === 800 || price === 7) return "Weekly";
  if (price === 2000 || price === 20) return "Monthly";
  if (price === 7500 || price === 60) return "Yearly";
  return "Weekly";
